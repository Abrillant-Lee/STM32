- [STM32综合案例](#stm32综合案例)
- [1.DHT11温湿度传感器](#1dht11温湿度传感器)
    - [1.1	DHT11简介](#11dht11简介)
    - [1.2 产品亮点](#12-产品亮点)
  - [1.3 外形尺寸](#13-外形尺寸)
    - [1.3.1 引脚说明](#131-引脚说明)
  - [1.4 产品参数](#14-产品参数)
    - [1.4.1 相对湿度](#141-相对湿度)
    - [1.4.2 相对温度](#142-相对温度)
  - [1.5 串行通信说明(单线双向)](#15-串行通信说明单线双向)
    - [1.5.1 单总线说明](#151-单总线说明)
    - [1.5.2 单总线传送数据位定义](#152-单总线传送数据位定义)
    - [1.5.3 校验位数据定义](#153-校验位数据定义)
  - [1.6 外设读取步骤(重要)](#16-外设读取步骤重要)
    - [1.6.1 步骤一:](#161-步骤一)
    - [1.6.2 步骤二:](#162-步骤二)
    - [1.6.3 步骤三:](#163-步骤三)
    - [1.6.4 步骤四:](#164-步骤四)
    - [1.6.5 结束信号:](#165-结束信号)
  - [1.7 DHT11获取温湿度实验](#17-dht11获取温湿度实验)
    - [1.7.1硬件设计](#171硬件设计)
    - [1.7.2软件设计](#172软件设计)
- [2.电流互感器/WCS1800霍尔电流传感器](#2电流互感器wcs1800霍尔电流传感器)
  - [2.1 WCS1800简介](#21-wcs1800简介)
    - [2.1.1 功能说明](#211-功能说明)
    - [2.1.2 外形尺寸](#212-外形尺寸)
    - [2.1.3 引脚说明](#213-引脚说明)
    - [2.1.4功能特点](#214功能特点)
    - [2.1.5 电气特性](#215-电气特性)
    - [2.1.6 模拟电压信号输出（AOUT）使用说明](#216-模拟电压信号输出aout使用说明)
    - [2.1.7 开关量输出（DOUT）使用说明](#217-开关量输出dout使用说明)
  - [2.2 WCS1800获取电压实验](#22-wcs1800获取电压实验)
    - [2.2.1 硬件设计](#221-硬件设计)
    - [2.2.2 软件设计(未校准)](#222-软件设计未校准)
- [3.编码器](#3编码器)
  - [3.1 简介](#31-简介)
    - [3.1.1 外形尺寸](#311-外形尺寸)
    - [3.2 增量式编码器原理](#32-增量式编码器原理)
  - [3.3 增量式编码器测速方法](#33-增量式编码器测速方法)
    - [3.3.1 M法](#331-m法)
    - [3.3.2 T法](#332-t法)
    - [3.3.3 M/T法](#333-mt法)
  - [3.4 STM32的编码器接口简介](#34-stm32的编码器接口简介)
  - [3.5 获取转速实验](#35-获取转速实验)
    - [3.5.1 硬件设计](#351-硬件设计)
    - [3.5.2 软件设计](#352-软件设计)
- [4.上传华为云平台](#4上传华为云平台)
  - [4.1 AT指令简介](#41-at指令简介)
  - [4.2. AT指令分类](#42-at指令分类)
  - [4.3 AT指令响应](#43-at指令响应)
  - [4.4.ESP32/ESP8266使用AT指令连接华为云并上报属性流程](#44esp32esp8266使用at指令连接华为云并上报属性流程)
  - [4.5 上传华为云实验](#45-上传华为云实验)
    - [4.5.1 硬件设计](#451-硬件设计)
    - [4.5.2 软件设计](#452-软件设计)
